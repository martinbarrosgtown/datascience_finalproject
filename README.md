...
Intro to Data Science Final Group Project. Composed of team members: Martin Barros, Gabriella Cova, Eva Langbehn, and Miguel Villa
December 2025
...
## Data
Data was pulled from various sources to build this dataset:
*include names/links of sources*

Countries covered: 158
Time period: 1994-2024 (30 years)
Number of observations: 3,918 (in training dataset)

Key outcome: Remittances as a % of GDP
Predictors used: Migrant stock, GDP per capita, unemployment, deportations, internet accss, inflation, terrorism index, distance between capital cities, poverty rate
