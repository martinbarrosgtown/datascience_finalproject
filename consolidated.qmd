...
The best model is **Random Forest** (lowest error: 3.08). Now we test it on completely new data.
...
```
On average, predictions are off by 2.52 percentage points.
The model explains 86% of the variation in remittances
