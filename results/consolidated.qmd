...
Filler out Missing Values in our key predicted outcome as this will cause our predicted models to fail, it provides no additional data to our model. However, for missingness in our predictors, imputation will help ensure non-systemic missingness adversely affect the sample size of our model.

```{r message=FALSE, warning=FALSE}
remittances <- read_csv("remittances.csv") |>
  clean_names() |>  # ← Add this line to clean column names FIRST
